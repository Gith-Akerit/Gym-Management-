...
const MAILS = {
  ...
  '5-member-welcome': {
    ...
    preheader: 'บัตรสมาชิกอยู่ในไฟล์แนบ · ตั้งรหัสผ่านเพื่อดูโปรแกรมฝึกได้ด้วย',
    title: 'บัตรสมาชิก',
    h1: 'ยินดีต้อนรับสู่ {{gym_name}}',
    blocks: [
      p('สวัสดีคุณ <strong style="color:' + INK + ';">{{name}}</strong>'),
      p('ขอบคุณที่สมัครสมาชิกกับ {{gym_name}}'),
      strongP('บัตรสมาชิกของคุณอยู่ในไฟล์แนบของอีเมลฉบับนี้'),
      p('บันทึกเก็บไว้ในมือถือ แล้วเปิดให้พนักงานสแกนทุกครั้งที่มาใช้บริการ'),
      note('รหัสสมาชิก <strong style="color:' + INK + ';">{{member_code}}</strong><br>' +
        'ใช้ได้ถึง <strong style="color:' + INK + ';">{{expires_at}}</strong>'),
      p('และคุณเข้าใช้ “ช่วยเล่น” ได้ด้วย รวมวิธีใช้เครื่องทุกเครื่อง เทคนิค และโปรแกรมฝึกตามเป้าหมาย ' +
        'ตั้งรหัสผ่านครั้งแรกที่ปุ่มด้านล่าง'),
      button('ตั้งรหัสผ่านของคุณ', '{{setpw_url}}'),
      fallbackLink('{{setpw_url}}'),
      note('ลิงก์ตั้งรหัสผ่านใช้ได้ <strong style="color:' + INK + ';">7 วัน</strong><br>' +
        'หมดอายุแล้วกด “ลืมรหัสผ่าน” ที่หน้าเข้าสู่ระบบเพื่อขอใหม่ได้'),
      strongP('บัตรสมาชิกใช้ได้เลยโดยไม่ต้องตั้งรหัสผ่าน การตั้งรหัสผ่านมีไว้สำหรับดูโปรแกรมฝึกเท่านั้น')
    ],
    text: [
      'ยินดีต้อนรับสู่ {{gym_name}}',
      '',
      'สวัสดีคุณ {{name}}',
      'ขอบคุณที่สมัครสมาชิกกับ {{gym_name}}',
      '',
      'บัตรสมาชิกของคุณอยู่ในไฟล์แนบของอีเมลฉบับนี้',
      'บันทึกเก็บไว้ในมือถือ แล้วเปิดให้พนักงานสแกนทุกครั้งที่มาใช้บริการ',
      '',
      'รหัสสมาชิก {{member_code}}',
      'ใช้ได้ถึง {{expires_at}}',
      '',
      'และคุณเข้าใช้ "ช่วยเล่น" ได้ด้วย รวมวิธีใช้เครื่องทุกเครื่อง เทคนิค',
      'และโปรแกรมฝึกตามเป้าหมาย ตั้งรหัสผ่านครั้งแรกที่ลิงก์นี้',
      '',
      '{{setpw_url}}',
      '',
      'ลิงก์ตั้งรหัสผ่านใช้ได้ 7 วัน',
      'หมดอายุแล้วกด "ลืมรหัสผ่าน" ที่หน้าเข้าสู่ระบบเพื่อขอใหม่ได้',
      '',
      'บัตรสมาชิกใช้ได้เลยโดยไม่ต้องตั้งรหัสผ่าน',
      'การตั้งรหัสผ่านมีไว้สำหรับดูโปรแกรมฝึกเท่านั้น',
      '',
      '--',
      '{{gym_name}} · โทร {{gym_phone}}',
      'อีเมลนี้ส่งอัตโนมัติ กรุณาอย่าตอบกลับ'
