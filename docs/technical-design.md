...
| GET | `/api/check-ins` | พนักงาน/แอดมิน | ประวัติ กรองตามวันและชื่อ |
...
- `npm test` — 79 เคสระดับ API ครอบคลุม migration ขึ้น-ลง-ขึ้น, OTP และ lockout, สิทธิ์, IDOR, injection, การ seed,
  validation ของแพ็กเกจ, PromptPay payload/CRC, การอัปโหลดสลิปและการปลอมชนิดไฟล์, การอนุมัติซ้ำ และการเพิกถอนสิทธิ์
- `npm run test:ui` — 12 เส้นทางผ่านเบราว์เซอร์จริง รวมหน้าจอ 320-390 px และตรวจว่าไม่มี JS error
