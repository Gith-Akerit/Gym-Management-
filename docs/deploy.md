...
```bash
cd /srv/gym && docker compose exec app npm run pilot:code -- owner@example.com
```

พิมพ์รหัส 6 หลักกับลิงก์ใช้ครั้งเดียวออกมา เปิดลิงก์บนมือถือแล้วกรอกรหัสภายใน 5 นาที **ต้องใช้ลิงก์ที่พิมพ์ออกมา** ไม่ใช่หน้าที่เปิดค้างไว้ เพราะการกด "ขอรหัสเข้าใช้งาน" ทุกครั้งจะยกเลิกรหัสก่อนหน้าเสมอ
