...
## สถานะบน `release/pilot` (`85bfa2d`)

| ชุด | ผล |
|---|---|
| `node --test qa/*.test.js` | **50/50** |
| `npm test` (ชุดของทีมพัฒนา) | **172/172** |
| `PLAYWRIGHT_CHANNEL=msedge npm run test:ui` | **42/42** บน Edge (รวม `09-tokens.spec.js` ที่ยก BRAND-UI-04 และ BRAND-UI-05 เข้าชุดถาวร) |
...
| `npx playwright test --config qa/playwright.qa.config.js` | **5/5** |
